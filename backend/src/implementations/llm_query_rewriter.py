...
from src.core.interfaces import ILLM, IQueryRewriter
...
class LLMQueryRewriter(IQueryRewriter):
    ...
    def __init__(self, llm: ILLM, num_variations: int = 3, temperature: float = 0.8, **kwargs):
        """
    ...
    def rewrite(self, query: str, **kwargs) -> list[str]:
        ...
        try:
            ...
            response = self.llm.generate(
                prompt=prompt, temperature=self.temperature, max_tokens=500
            )
