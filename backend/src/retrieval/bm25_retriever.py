...
class BM25Retriever(IRetriever):
    ...
    def __init__(self, documents: list[Document], config: BM25RetrieverConfig | None = None):
        """
    ...
    def retrieve(
        ...
        for idx, doc in enumerate(self.documents):
            ...
            doc_copy = Document(
                doc_id=doc.doc_id,
                content=doc.content,
                metadata={**doc.metadata, "bm25_score": score, "score": score},
            )
